...
base_ckpt_path = '../cache/zavychromaxl_v30.safetensors'
...
for i in range(18):
    ...
    pil_rec.save(f"{rec_path}{i}/{gen_rep}.png")
    
    pil_rec_blurry = transforms.ToPILImage()(all_blurryrecons[i])
    pil_rec_blurry.save(f"{rec_path}{i}/low_level.png")
    ...
    with open(f"{rec_path}{i}/decoded_caption_{gen_rep}.txt", "w") as file:
        file.write(decoded_caption)
