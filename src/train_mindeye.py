...
class BrainNetwork(nn.Module):
    def __init__(self, out_dim=768, in_dim=15724, clip_size=768, h=2048, n_blocks=4, norm_type='ln', act_first=False, use_projector=True):
        super().__init__()
...
voxel2clip_kwargs = dict(in_dim=num_voxels,out_dim=77*2048,clip_size=clip_size,use_projector=use_projector)
