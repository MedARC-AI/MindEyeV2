        ...
        with torch.no_grad(), torch.cuda.amp.autocast(dtype=data_type): 
            for test_i, (behav, past_behav, future_behav, old_behav) in enumerate(test_dl):  
                ...
                for rep in range(3):
                    ...
                    clip_voxels0 = model.backbone(voxel_ridge)
                    if rep==0:
...
print("\n===Finished!===\n")
accelerator.save_state('/weka/proj-fmri/mihirneal/MindEyeV2/src/ablation_ckpt/re_only_cont')
save_ckpt(f're_only_cont')
if ckpt_saving:
    save_ckpt(f're_only_cont')
