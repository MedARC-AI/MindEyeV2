...
print(backbone_.shape, clip_.shape)
...
for epoch in progress_bar:
    ...
    for train_i in range(num_iterations_per_epoch):
        with torch.cuda.amp.autocast(dtype=data_type):
            ...
            backbone, clip_voxels = model.backbone(voxel_ridge)
...
print("\n===Finished!===\n")
accelerator.save_state('/weka/proj-fmri/mihirneal/MindEyeV2/src/ablation_ckpt/re_cont_prior')
save_ckpt(f're_cont_prior')
if ckpt_saving:
    save_ckpt(f're_cont_prior')
